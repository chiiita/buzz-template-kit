 ...
 *{box-sizing:border-box} body{margin:0;font-family:'Zen Kaku Gothic New',system-ui,sans-serif;-webkit-font-smoothing:antialiased;background:var(--bg);color:var(--txt);display:flex;height:100vh;overflow:hidden;font-size:13px}
 ...
 #ver{position:absolute;top:8px;right:12px;font-size:10px;color:var(--faint);z-index:6;letter-spacing:.04em}
...
<div id="mid"><div id="topbar"><button id="movebtn" onclick="toggleMove()"><span id="movestate">🔒 編集モード：オフ</span><span id="movesub">押すと文字・画像を動かせます</span></button></div><div id="preview"><div id="stage"><div id="card"></div></div><div id="ovwarn">⚠ 文字がはみ出している可能性</div><div id="ver">build 2026-06-11d</div></div><div id="deckbar"></div></div>
